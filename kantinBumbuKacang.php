...
<body>
    ...
    <section class="daftarKantin">
        <article class="kantin">
            ...
            <a href="#">
                <div class="gambarKantinHover" style="background-image: url(images/Resep-Ketoprak-Jakarta-Enak.jpg);"></div>
            </a>
            
            <div class="descKantin">
                <h3 class="judulKantin">Ketoprak</h3>
        ...
        <article class="kantin">
            ...
            <div class="gambarKantin"></div>
            <a href="#">
                <div class="gambarKantinHover" style="background-image: url(images/Resep-Gado-Gado.webp);"></div>
            </a>
            
            <div class="descKantin">
                <h3 class="judulKantin">Gado-gado</h3>
        ...
        <article class="kantin">
            ...
            <div class="gambarKantin"></div>
            <a href="#">
                <div class="gambarKantinHover" style="background-image: url(images/doclang.jpg);"></div>
            </a>
            
            <div class="descKantin">
                <h3 class="judulKantin">Doclang</h3>
                <p class="kisaranHarga">IDR 10.000</p>
                <a class="tambahItem" href="#">
                    <img src="icon/+cartKuning.svg" alt="">
                </a>
        ...
        <article class="kantin">
            ...
            <div class="gambarKantin"></div>
            <a href="#">
                <div class="gambarKantinHover" style="background-image: url(images/Resep-Siomay-Bandung.webp);"></div>
            </a>
            
            <div class="descKantin">
                <h3 class="judulKantin">Siomay</h3>
                <p class="kisaranHarga">IDR 10.000</p>
                <a class="tambahItem" href="#">
                    <img src="icon/+cartKuning.svg" alt="">
                </a>
